...
# September 15 2026 - Today's study goal is: Scope / local and global variables / *args / **kwargs
#                    
#
#*******************************************************************************************
# Part A - SCOPE
#*********************************************
#
# Part A.1. Create a global variable course_name and a function that creates a local variable with the same name.
#           Print both and explani the result.
...
# Part A.2. Create a function with a local counter and show that it does not remain available outside the function.
...
#     numer_global = number * number #UnboundLocalError: cannot access local variable 'numer_global' where it is not associated with a value
...
# F.1 Build a flexible report system without files. create_raport(title, *sections, **metadata) should return a dictionary.
...
# F.7 Demonstrate at least one case where you function deliberately ignores or handles a missing optional metadata field.
